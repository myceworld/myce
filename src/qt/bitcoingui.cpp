                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QWidget *spacerWidget4 = new QWidget();
            spacerWidget4->setSizePolicy(QSizePolicy::Fixed, QSizePolicy::Fixed);
            spacerWidget4->setFixedSize(3,3);
            spacerWidget4->setVisible(true);
            spacerWidget4->setStyleSheet("background-color:transparent;");

            frameBlocksLayout->addWidget(spacerWidget4);
    ...
    QWidget *spacerWidget3 = new QWidget();
            spacerWidget3->setSizePolicy(QSizePolicy::Fixed, QSizePolicy::Fixed);
            spacerWidget3->setMinimumSize(1,1);
            spacerWidget3->setMaximumSize(1,1);
            spacerWidget3->setVisible(true);
            spacerWidget3->setStyleSheet("background-color:transparent;");

            statusBar()->addWidget(spacerWidget3);
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    aboutAction = new QAction(tr("&About MYCE Core"), this);
